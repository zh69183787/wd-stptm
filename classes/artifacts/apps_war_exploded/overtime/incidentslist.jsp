	...
	<div class="main">
		...
		<div class="tabs_2">
			<ul id="urlist" style="float:left">
				...
				<li><a href="showSubprocessList.action"><span>合同审批查询</span>
				</a>
				</li>
				<li><a href="showTaskList.action"><span>直接备案查询</span> </a>
				</li>
				<li class="selected"><a href="showIncidentsList.action"><span>维保合同审批查询</span>
				</a>
				</li>
		...
		<div class="filter">
			...
			<div class="query p8">
				<s:form action="showIncidentsList" id="form"
					name="/showIncidentsList" namespace="/overtime" method="post">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td><select id="status" name="htxx.status">
		...
		<div class="mb10">
			...
			<table width="100%" class="table_1">
				...
				<tr class="tfoot">
					<td colspan="15">
						<div class="clearfix">
							<span class="fl"><s:property value="#r.pageInfo.totalRow" />条记录,当前显<s:property value="#request.startIndex"/>-<s:property value="#request.endIndex"/>条记录</span>
