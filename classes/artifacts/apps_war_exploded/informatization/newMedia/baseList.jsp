...
<head>
<meta charset="utf-8" />
<title>团组织新媒体建设信息（汇总情况以公司为单位）</title>
...
<!--[if IE 6.0]>
	  ...
	  if(confirm("确定删除?")){
		$.ajax({
			url: "<%=basePath%>/newMedia/deleteData.action",
			dataType: "json",
			data: {
				"id" : id
			},
        ...
        function editData(id){
          newWindow=window.open("findGroupNewMediaById.action?id="+id+"&type=edit");
        }
        //跳转到制定页
	...
	<div class="main">
		...
		<div class="ctrl clearfix">
            ...
            <div class="posi fl">
            	<ul>
                	...
                	<li class="fin">团组织新媒体建设信息（汇总情况以公司为单位）</li>
                </ul>
            </div>
        ...
        <div class="tabs_2">
        	<ul>
           		...
           		<li class="selected"><a href="<%=basePath %>/newMedia/findGroupNewMediaByPage.action"><span>团组织网站建设情况</span></a></li>
      ...
      <div class="filter">
        	<div class="query p8">
        	<s:form action="findGroupNewMediaByPage" id="form" name="newMedia" namespace="/newMedia">        	
        	<input type="hidden"  value="" name="number" id="pageNo"/>
        	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        	    <tr>
        	      <td class="t_r">名称(所属直属单位团组织)</td>
        	      <td>
...
<input type="button" value="重置" onclick="clearInput()"/> &nbsp;&nbsp;
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              <thead>
                                  <th colspan="18">团组织新媒体建设信息（汇总情况以公司为单位）</th>
                              </thead>    
                              <tbody>
                              <tr class="tit">
                                <td>序号</td>
                               ...
                               <s:iterator value="#request.page.result" status="st">
	 	                          <tr id="dataTR">
	 	                            ...
	 	                            <td class="t_c"><s:property value="directlyUnitName"/></td>
	 	                           
	 	                            <td class="t_c"><s:property value="startTime"/></td>
	 	                            <td class="t_c">
	 	                            
	 	                            <s:property value="webIntroduction"/></td>
	 	                            <td class="t_c"><s:property value="honor"/></td>	                      	 	                            
	 	                            <td class="t_c"><s:property value="independentDomain"/></td>
	 	                            <td class="t_c" ><s:property value="averageDailyTraffic"/></td>
	 	                            
	 	                            <td class="t_c">
	  	                            <a class="fl mr5" href="findGroupNewMediaById.action?id=<s:property value='id'/>&type=view" target="_blank" >查看</a> 
