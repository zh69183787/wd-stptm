...
<head>
<meta charset="utf-8" />
<title>本级和下级团组织利用其他新闻媒体手段开展工作情况</title>
...
<!--[if IE 6.0]>
	  ...
	  if(confirm("确定删除?")){
		$.ajax({
			url: "<%=basePath%>/work/deleteData.action",
			dataType: "json",
			data: {
				"id" : id
			},
        ...
        function editData(id){
          newWindow=window.open("findGroupWorkById.action?id="+id+"&type=edit");
        }
        //跳转到制定页
	...
	<div class="main">
		...
		<div class="ctrl clearfix">
            ...
            <div class="posi fl">
            	<ul>
                	...
                	<li class="fin">本级和下级团组织利用其他新闻媒体手段开展工作情况</li>
                </ul>
            </div>
        ...
        <div class="tabs_2">
        	<ul>
           		...
           		<li class="selected"><a href="<%=basePath %>/work/findGroupWorkByPage.action"><span>其他新媒体开展工作</span></a></li>
      ...
      <div class="filter">
        	<div class="query p8">
        	<s:form action="findGroupWorkByPage" id="form" name="work" namespace="/work">        	
...
<input type="button" value="重置" onclick="clearInput()"/> &nbsp;&nbsp;
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              <thead>
                                  <th colspan="18">本级和下级团组织利用其他新闻媒体手段开展工作情况</th>
                              </thead>    
                              <tbody>
                              <tr class="tit">
                                <td>序号</td>
                               ...
                               <s:iterator value="#request.page.result" status="st">
	 	                          <tr id="dataTR">
	 	                            ...
	 	                            <td class="t_c"><s:property value="technicalMeans"/></td>
	 	                           
	 	                            <td class="t_c"><s:property value="directlyUnitName"/></td>
	 	                            <td class="t_c"><s:property value="release"/></td>
	 	                            <td class="t_c"><s:property value="coverPepole"/></td>	                      	 	                            
	 	                            ...
	 	                            <td class="t_c">
	  	                            <a class="fl mr5" href="findGroupWorkById.action?id=<s:property value='id'/>&type=view" target="_blank" >查看</a> 
