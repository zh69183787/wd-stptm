...
<head>
<meta charset="utf-8" />
<title>本级和下级团组织利用新媒体工具拓宽沟通和响应渠道情况数据录入</title>
...
<input type="hidden" id="addSuccess" value="<s:property value='#request.addSuccess'/>"/>
	...
	<div class="main">
		...
		<div class="ctrl clearfix">
            ...
            <div class="posi fl">
            	<ul>
                	...
                	<li class="fin">本级和下级团组织利用新媒体工具拓宽沟通和响应渠道情况数据录入</li>
                </ul>
            </div>
        ...
        <!--Table-->
        <div class="mb10">
        <s:form action="add" name="communication" namespace="/communication" method="post">
            ...
            <th colspan="4" class="t_r"><input type="submit" value="确 认" onclick="return check();"/>
       	      ...
       	      &nbsp;</th>
                              ...
                              <tr>
                                ...
                                <td>
                                <input type="text" id="honor" name="honor" class="input_large" maxlength="50" /></td>
                              ...
                              <tr>
                                ...
                                <td>
                                <input type="text" id="linkName" name="linkName" class="input_large" maxlength="50" />
                                </td>
                                <td class="t_r lableTd">手机</td>
                                <td>
                                <input type="text" id="mobilPhone" name="mobilPhone" class="input_large" maxlength="11" />
                                </td>
                                </tr>
                              </tbody>
                              <tr class="tfoot">
