...
$(function(){
	...
	$("#job").val($("#h_job").val());
	$("#gender").val($("#h_gender").val());
	$("#politicsStatus").val($("#h_politicsStatus").val());
	$("#degree").val($("#h_degree").val());
	$("#levelEducation").val($("#h_levelEducation").val());
});
        </script></head>
...
<body>
	...
	<div class="main">
        ...
        <!--Table-->
        <div class="mb10">
        <s:form action="updateGroupLeaderId" name="leader" namespace="/leader">
            ...
            <th colspan="4" class="t_r"><input type="submit" value="确 认" onclick="return check();"/>
        	      ...
        	      &nbsp;        	      
                              ...
                              <tr>
                                ...
                                <td style="color:red"><input type="text" id="branchName" value="<s:property value='avo.branchName' />" name="branchName" class="input_large" maxlength="50" />&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                              <tr>
                                <td class="t_r lableTd">支部书记</td>
                                <td><input type="text" id="branchSecretary" name="branchSecretary" value="<s:property value='avo.branchSecretary'/>" maxlength="50" class="input_large" /></td>
                                <td class="t_r lableTd">支部人数</td>
                                <td>
                                <input type="text" id="branchNumber" name="branchNumber" value="<s:property value='avo.branchNumber'/>" maxlength="50" class="input_large" /></td>
                              ...
                              <tr>
                                ...
                                <input type="hidden" id="h_job" value="<s:property value='avo.job'/>"/>
                                </td>
                                ...
                                <input type="hidden" id="h_gender" value="<s:property value='avo.gender'/>"/>
                                </td>
                                </tr>
                              <tr>
                                <td class="t_r lableTd">出生年月</td>
                                <td><input type="text" id="birthday" name="birthday" value="<s:property value='avo.birthday'/>"  maxlength="20" class="input_large" /></td>
                                ...
                                <input type="hidden" id="h_politicsStatus" value="<s:property value='avo.politicsStatus'/>" />
                                </td>
                              </tr>
                              <tr>
                                ...
                                <input type="hidden" id="h_levelEducation" value="<s:property value='avo.levelEducation'/>"/>
                                 </td>
                                ...
                                <input type="hidden" id="h_degree" value="<s:property value='avo.degree' />"/>
                                </td>
                              </tr>
                              <tr>
                                <td class="t_r lableTd">岗位职务</td>
                                <td><input type="text" id="postOffice" name="postOffice" value="<s:property value='avo.postOffice' />" maxlength="60" class="input_large" /></td>
                                <td class="t_r lableTd">职称或技术等级</td>
                                <td><input type="text" id="titleorTechnicalLevel" name="titleorTechnicalLevel" value="<s:property value='avo.titleorTechnicalLevel' />" maxlength="60" class="input_large" /></td>
                              </tr>
                              <tr>
                                <td class="t_r lableTd">手机</td>
                                <td><input type="text" id="mobilPhone" name="mobilPhone" value="<s:property value='avo.mobilPhone' />" maxlength="11" class="input_large" /></td>
                                <td class="t_r lableTd">微博与微信名</td>
                                <td><input type="text" id="wiboorMicro" name="wiboorMicro" value="<s:property  value='avo.wiboorMicro'/>" maxlength="60" class="input_large" /></td>
                             </tr>
                           		<tr>
                                <td class="t_r lableTd">全职或兼职</td>
                                <td><input type="text" id="fullorParttime" name="fullorParttime" value="<s:property value='avo.fullorParttime' />" maxlength="60" class="input_large" /></td>
                              </tr>
                              </tbody>
                              <tr class="tfoot">
