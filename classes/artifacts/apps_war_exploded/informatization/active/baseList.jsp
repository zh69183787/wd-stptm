...
<!--[if IE 6.0]>
	  ...
	  if(confirm("确定删除?")){
		$.ajax({
			url: "<%=basePath%>/active/deleteData.action",
			dataType: "json",
			data: {
				"id" : id
			},
	...
	<div class="main">
        ...
        <div class="tabs_2">
        	<ul>
           		...
           		<li class="selected"><a href="<%=basePath %>/active/findByPage.action"><span>新媒体活动</span></a></li>
      ...
      <div class="filter">
        	<div class="query p8">
        	<s:form action="findByPage" id="form" name="active" namespace="/active">        	
        	<input type="hidden"  value="" name="number" id="pageNo"/>
        	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        	    <tr>
        	      <td class="t_r">活动（话题）名称</td>
        	      <td>
       	          <input type="text" id="activeName" name="activeName" class="input_large" value="<s:property value='activeName'/>"/>
       	          </td>
        	    <tr>
                              ...
                              <tr class="tit">
                               ...
                               <s:iterator value="#request.page.result" status="st">
	 	                          <tr id="dataTR">
	 	                            ...
	 	                            <td class="t_c"><s:property value="activeName"/></td>
	 	                           
	 	                            <td class="t_c"><s:property value="startTime"/></td>
	 	                            <td class="t_c"><s:property value="activeIntroduction"/></td>
	 	                            <td class="t_c"><s:property value="influence_covers_the_youth"/></td>	                      	 	                            
