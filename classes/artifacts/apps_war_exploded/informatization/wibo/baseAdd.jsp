...
<input type="hidden" id="addSuccess" value="<s:property value='#request.addSuccess'/>"/>
	...
	<div class="main">
        ...
        <!--Table-->
        <div class="mb10">
        <s:form action="add" name="wibo" namespace="/wibo" method="post">
            ...
            <th colspan="4" class="t_r"><input type="submit" value="确 认" onclick="return check();"/>
       	      ...
       	      &nbsp;</th>
                              ...
                              <tr>
                                ...
                                <input type="text" id="wiboName" name="wiboName" maxlength="50" class="input_large" />
                                &nbsp;&nbsp;*
                                </td>
                              ...
                              <tr>
                                ...
                                <td><input type="text" id="linkName" name="linkName" maxlength="50" class="input_large" /></td>
                              ...
                              <tr>
                                ...
                                <td colspan="3"><input type="text" id="wiboAddress" name="wiboAddress" maxlength="100" style="width:82%;"/></td>
                                </tr>
                              </tbody>
                              <tr class="tfoot">
