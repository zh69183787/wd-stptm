       ...
       <![endif]-->
        ...
        $(document).ready(function () {
            ...
            $tbInfo.each(function () {
                $(this).focus(function () {
                    $(this).attr("placeholder", "");//保存检索过得字段html5中input新属性placeholder
                });
            });
        ...
        function deleteData(id){
      	  if(confirm("确定删除?")){
      		$.ajax({
      		url:"<%=basePath%>/member/deleteData.action",
      		dataType:"json",
      		data:{"id":id},
        ...
        function editData(id){
          newWindow=window.open("findGroupMemberById.action?id="+id+"&type=edit");
        }
        //跳转到制定页
...
function countAll(){
	$.ajax({
		url: "<%=basePath%>/member/countAll.action",
		type: 'post', 
		dataType: 'json', 
		error:function(){
			alert("系统连接失败，请稍后再试！");
		...
		success: function(obj){	
	          if(obj!=null&&obj.length>0){
				...
				$("#titleTr").after("<tr><td class='t_c' colspan='3'>统计</td><td class='t_c'>"+obj[0][0]+"</td><td class='t_c'>"+obj[0][1]+"</td><td class='t_c'>"+obj[0][2]+"</td><td class='t_c'>"+obj[0][3]+"</td><td class='t_c'>"+obj[0][4]+"</td><td class='t_c'>"+obj[0][5]+"</td><td class='t_c'>"+obj[0][6]+"</td><td class='t_c'>"+obj[0][7]+"</td><td class='t_c'>"+obj[0][8]+"</td><td class='t_c'>&nbsp;</td></tr>");
          }
		}
	});	
}
...
<iframe id="iframe" style="display:none;"></iframe>	
	<div class="main">
        ...
        <div class="tabs_2">
        	<ul>
           		<li class="selected"><a href="<%=basePath %>/member/findGroupMemberByPage.action"><span>青年信息</span></a></li>
      ...
      <div class="filter">
        	<div class="query p8">
        	<s:form action="findGroupMemberByPage" id="form" name="member" namespace="/member">        	
...
<input type="button" value="重置" onclick="clearInput()"/> &nbsp;&nbsp;
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              <thead>
                                  <th colspan="18">团员青年信息</th>
                              </thead>    
                              <tbody>
                              <tr class="tit" id="titleTr">
                                <td>序号</td>
                                <td >更新日期</td>
                                <td>单位</td>
                                <td>共青团员男</td>
                                <td>共青团员女</td>
                                <td>28岁党员（含28岁）</td>                                                           
                                <td>35岁以下青年（含35岁）男</td>
                                <td>35岁以下青年（含35岁）女</td>
                                <td>28岁以下未入团青年（含28岁）</td>
                                <td>35岁党员（含35岁）</td>
                                <td>今年新入团人数</td>
                                <td>今年推优入党人数</td>
                                <td>操作</td>
                               ...
                               <s:iterator value="#request.page.result" status="st">
	 	                          <tr id="dataTR">
	 	                            ...
	 	                            <td class="t_c"><s:property value="updateDate"/></td>  
	 	                            <td class="t_c"><s:property value="unit"/></td>
	 	                            <td class="t_c"><s:property value="groupMale"/></td>
	 	                            <td class="t_c"><s:property value="groupFemMale"/></td>
	 	                            <td class="t_c"><s:property value="member28"/></td>	                      	 	                            
	 	                            <td class="t_c"><s:property value="under_35YouthMale"/></td>
	 	                            <td class="t_c" ><s:property value="under_35YouthFemale"/></td>
	 	                            <td class="t_c"><s:property value="under_28YouthNotGroup"/></td> 
	 	                            <td class="t_c" ><s:property value="member35"/></td>
	 	                            <td class="t_c"><s:property value="newGroup"/></td> 
	 	                            <td class="t_c"><s:property value="newMember"/></td> 
	 	                            
	 	                            <td class="t_c">
	 	                            
	  	                            <a   class="fl mr5" href="findGroupMemberById.action?id=<s:property value='id'/>&type=view" target="_blank" >查看</a> 
