...
<!--[if IE 6.0]>
       ...
       <![endif]-->
        ...
        $(function(){
			$('#orgLastDateStart').datepicker({
				//inline: true								
				"changeYear":true,
				"showButtonPanel":true,	
				"closeText":'清除',	
				"currentText":'orgLastDateStart'//仅作为“清除”按钮的判断条件
			});
						
			//$("#indicatorDate").datepicker('option', $.datepicker.regional['zh-CN']); 
			$('#orgLastDateEnd').datepicker({
				//inline: true
				"changeYear":true,
				"showButtonPanel":true,	
				"closeText":'清除',	
				"currentText":'orgLastDateEnd'//仅作为“清除”按钮的判断条件
			});

            $('#nowLastDateStart').datepicker({
                //inline: true
                "changeYear":true,
                "showButtonPanel":true,
                "closeText":'清除',
                "currentText":'nowLastDateStart'//仅作为“清除”按钮的判断条件
            });

            //$("#indicatorDate").datepicker('option', $.datepicker.regional['zh-CN']);
            $('#nowLastDateEnd').datepicker({
                //inline: true
                "changeYear":true,
                "showButtonPanel":true,
                "closeText":'清除',
                "currentText":'nowLastDateEnd'//仅作为“清除”按钮的判断条件
            });
            ...
            $(".ui-datepicker-close").live("click", function (){              
              if($(this).parent("div").children("button:eq(0)").text()=="orgLastDateStart") $("#orgLastDateStart").val("");
              if($(this).parent("div").children("button:eq(0)").text()=="orgLastDateEnd") $("#orgLastDateEnd").val("");
                if($(this).parent("div").children("button:eq(0)").text()=="nowLastDateStart") $("#nowLastDateStart").val("");
                if($(this).parent("div").children("button:eq(0)").text()=="nowLastDateEnd") $("#nowLastDateEnd").val("");
        ...
        function clearInput(){
          ...
          $("#nowLastDateStart").val("");
          $("#nowLastDateEnd").val("");
            $("#orgLastDateStart").val("");
            $("#orgLastDateEnd").val("");
...
<input type="hidden" id="h_inputDept" name="h_inputDept" value="<s:property  value='hiddenDangersCorrectVO.inputDept'/>" />
	<div class="main" style="width:1304px;margin: auto;">
      ...
      <div class="filter">
        	...
        	<s:form action="findHdcLogByPage" id="form" name="HiddenDangersCorrect" namespace="/hiddenDangersCorrect">
        	...
        	<input type="hidden"  value="<s:property value='#request.operateType'/>" name="operateType" id="operateType"/>
        	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        	    <tr>
        	      ...
        	      <td >
        	      <input readonly="readonly" name="nowLastDateStart" id="nowLastDateStart" type="text" value="<s:property value='#request.nowLastDateStart'/>" class="input_large"/>至
        	      <input readonly="readonly" name="nowLastDateEnd" id="nowLastDateEnd" type="text" value="<s:property value='#request.nowLastDateEnd'/>" class="input_large"/>
        	      </td> 
        	   ...
        	   <tr>
      	      ...
      	      <tr>
                  ...
                  <td class="t_r">原整改时限</td>
                  <td >
                      <input readonly="readonly" name="orgLastDateStart" id="orgLastDateStart" type="text" value="<s:property value='#request.orgLastDateStart'/>" class="input_large"/>至
                      <input readonly="readonly" name="orgLastDateEnd" id="orgLastDateEnd" type="text" value="<s:property value='#request.orgLastDateEnd'/>" class="input_large"/>
                  </td>
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              ...
                              <tr class="tit">
                                ...
                                <td class="t_c" style="white-space:nowrap;">&nbsp;&nbsp;原整改时限&nbsp;&nbsp;</td>
                                <td class="t_c" style="white-space:nowrap;">&nbsp;&nbsp;现整改时限&nbsp;&nbsp;</td>
                               ...
                               <s:iterator value="#request.page.result" status="st" id="oo">
	 	                          <tr id="dataTR">
	 	                            <td class="t_c"><s:property value="#st.index+#request.page.start"/></td>
	 	                            <td ><s:property value="lines"/></td>
	 	                            <td id="dangersState_show" title="<s:property value="#oo[0].dangersState"/>"><s:property value="#oo[0].dangersState"/></td>
	 	                            <td id="correctMethod_show" title="<s:property value="#oo[0].correctMethod"/>"><s:property value="#oo[0].correctMethod"/></td>
	 	                            <td class="t_c" id="dangersClass_show"><s:property value="#oo[0].dangersClass"/></td>
	 	                            <td class="t_c"><s:property value="#oo[0].major"/></td>
	 	                            <td class="t_c"><s:date name="#oo[1].orgLastDate" format="yyyy-MM-dd"/></td>
                                      <td class="t_c"><s:date name="#oo[1].nowLastDate" format="yyyy-MM-dd"/></td>
	 	                            <td class="t_c" id="workState_show"><s:property value="#oo[0].workState"/></td>
	 	                            <td class="t_c"><s:date name="#oo[0].finishDate" format="yyyy-MM-dd"/></td>
	 	                            <td class="t_c"><s:property value="#oo[0].workDept"/></td>
	 	                            <td class="t_c"><s:property value="#oo[0].workPerson"/></td>
	 	                            <td class="t_c"><s:property value="#oo[0].inputDept"/></td>
	 	                            <td class="t_c" id="importance_show"><s:property value="#oo[0].importance"/></td>
	 	                            <td class="t_c"><s:date name="#oo[0].inputDate" format="yyyy-MM-dd"/></td>
	 	                            <td class="t_c" id="remark_show">详细<span style="display:none"><s:property value="#oo[0].remark"/></span></td>
	 	                            <%-- <td class="t_c" id="checkState_show"><s:property value="checkState"/></td> --%>
	 	                      		<td class="t_c">
	  	                            	<a class="fl mr5" href="findHdcLogById.action?id=<s:property value='#oo[0].id'/>&logId=<s:property value='#oo[1].id'/>&type=view" target="_blank" >查看</a>
