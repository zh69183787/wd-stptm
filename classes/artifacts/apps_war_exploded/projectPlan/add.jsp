...
<body>
	<div class="main">
        ...
        <!--Table-->
        <div class="mb10">
        <s:form action="addProjectPlan" name="ProjectPlan" namespace="/projectPlan">
        	<input type="hidden" name="applyCompany" />
       	      ...
       	      &nbsp;</th>
                              ...
                              <tr>
	                              <td class="t_r lableTd" style="width:20%;">计划项目名称</td>
	                                <td style="width:30%;"><input type="text" id="planProjectName" name="planProjectName" maxlength="50" class="input_xxlarge"/></td>
                              ...
                              <tr>
                                ...
                                <td><input type="text" id="property" name="property" maxlength="50" class="input_large"/></td>
                                <td class="t_r lableTd">概算(万元)</td>
                                <td><input type="text" id="estimate" name="estimate" maxlength="50" class="input_large"/></td>
                              </tr>
                              <tr>
                                <td class="t_r lableTd">立项依据</td>
                                <td colspan="3"><textarea id="according" name="according" rows="5" cols="10" style="overflow:auto;  border-width:1"></textarea></td>
                               
                                </tr>
                              <tr>
                                <td class="t_r lableTd">实施方案</td>
                                <td colspan="3"><textarea id="plan" name="plan" rows="5" cols="10" style="overflow:auto;  border-width:1"></textarea></td>
                               
                                </tr>
                               <tr>
                                <td class="t_r lableTd">项目目标</td>
                                <td colspan="3"><textarea id="target" name="target" rows="5" cols="10" style="overflow:auto;  border-width:1"></textarea></td>
