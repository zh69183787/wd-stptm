...
String dwlmId="356";//当前单位总栏目ID
String dtgzId="357";//动态工作
//公开查询
String dzzjyId="509";//党组织决议决定及执行
String ddsxId="510";//党的思想建设
String ddzzId="511";//党的组织管理
String ldbzId="512";//领导班子建设
String gbxrId="513";//干部选任和管理
String lxhffId="514";//联系和服务党员、群众
String dflzId="515";//党风廉政建设
String qtgkId="516";//其他公开内容

String jqgkId="1348";//近期公开重点
//公开制度机制
...
<div class="wrap">
  <div class="leftside">
    <div class="gzxx">
      <h3><a href="#" style="cursor:default"><em> 运营一公司-动态工作信息</em></a></h3>
      <div class="gzxx-info" >
...
%> 
    ...
    <div class="p_link">
     ...
     <ul class="t_news_tit">
        ...
        <li><a href="yy1gs.jsp" class="f-yh current">运营一公司</a></li>
