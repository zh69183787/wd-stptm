...
String dwlmId="1073";//当前单位总栏目ID
String dtgzId="1381";//动态工作
//公开查询
String dzzjyId="1075";//党组织决议决定及执行
String ddsxId="1076";//党的思想建设
String ddzzId="1077";//党的组织管理
String ldbzId="1078";//领导班子建设
String gbxrId="1079";//干部选任和管理
String lxhffId="1080";//联系和服务党员、群众
String dflzId="1081";//党风廉政建设
String qtgkId="1082";//其他公开内容

String jqgkId="1384";//近期公开重点
//公开制度机制
String gzgkId="1420";//工作公开组织结构
String dwgkId="1421";//党务公开目录
String dzwjId="1422";//工作文件制度
%>
...
<div class="wrap">
  <div class="leftside">
    <div class="gzxx">
      <h3><a href="#" style="cursor:default"><em> 运营四公司-动态工作信息</em></a></h3>
      <div class="gzxx-info" >
    ...
    <div class="p_link">
      <h3><em class="pubic"><a href="#" class="f-yh" style="cursor:default">各直属党组织链接</a></em></h3>
       <ul class="t_news_tit">
        ...
        <li><a href="yy4gs.jsp" class="f-yh current">运营四公司</a></li>
