...
String dwlmId="465";//当前单位总栏目ID
String dtgzId="681";//动态工作
//公开查询
String dzzjyId="467";//党组织决议决定及执行
String ddsxId="485";//党的思想建设
String ddzzId="486";//党的组织管理
String ldbzId="487";//领导班子建设
String gbxrId="488";//干部选任和管理
String lxhffId="489";//联系和服务党员、群众
String dflzId="490";//党风廉政建设
String qtgkId="491";//其他公开内容

String jqgkId="682";//近期公开重点
//公开制度机制
String gzgkId="685";//工作公开组织结构
String dwgkId="686";//党务公开目录
String dzwjId="687";//工作文件制度
%>
...
<div class="wrap">
  <div class="leftside">
    <div class="gzxx">
      <h3><a href="#" style="cursor:default"><em>维保中心-动态工作信息</em></a></h3>
      <div class="gzxx-info" >
...
%> 
    ...
    <div class="p_link">
      ...
      <ul class="t_news_tit">
        ...
        <li><a href="wbzx.jsp" class="f-yh current">维保中心</a></li>
