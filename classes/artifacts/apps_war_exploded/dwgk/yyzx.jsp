...
String dwlmId="378";//当前单位总栏目ID
String dtgzId="1146";//动态工作
//公开查询
String dzzjyId="379";//党组织决议决定及执行
String ddsxId="380";//党的思想建设
String ddzzId="381";//党的组织管理
String ldbzId="382";//领导班子建设
String gbxrId="383";//干部选任和管理
String lxhffId="384";//联系和服务党员、群众
String dflzId="385";//党风廉政建设
String qtgkId="386";//其他公开内容

String jqgkId="1147";//近期公开重点
//公开制度机制
String gzgkId="1150";//工作公开组织结构
String dwgkId="1151";//党务公开目录
String dzwjId="1152";//工作文件制度
%>
...
<div class="wrap">
  <div class="leftside">
    <div class="gzxx">
      <h3><a href="#" style="cursor:default"><em>运营中心-动态工作信息</em></a></h3>
      <div class="gzxx-info" >
...
%>  
    ...
    <div class="p_link">
      ...
      <ul class="t_news_tit">
        ...
        <li><a href="yyzx.jsp" class="f-yh current ">运管中心</a></li>
