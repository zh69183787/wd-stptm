		...
		<table width="100%" class="table_1">
			...
			<tbody>
				<tr class="tit">
					...
					<td class="t_c">规格</td>
					<td class="t_c">原值(元)</td>
					<td class="t_c">净值(元)</td>
					<td class="t_c">出厂价(元)</td>
					<td class="t_c">决算价(元)</td>
					<td class="t_c">修改时间</td>
					<td colspan="3">操作</td>
				</tr>
				
				<s:iterator value="#request.historyList" id="list" status="st">
					<tr class="t_c">
						<td class="t_c">
							<s:property value="#st.index+1"/>
						</td>
						<!--<td><s:property value="#assetInfo.assetId"/></td>-->
						<td><s:property value="#list.assetName"/></td>
						<td><s:property value="#list.specification"/></td>
						<!--<td><s:property value="#assetInfo.model"/></td>-->
						<td class="t_c"><s:property value="#list.yuanzhi"/></td>
						<td class="t_c"><s:property value="#list.jingzhi"/></td>
						<td class="t_c"><s:property value="#list.leaveFactoryPrice"/></td>
						<td class="t_c"><s:property value="#list.finalAccountPrice"/></td>
						<td class="t_c"><s:property value="#list.operateTime"/></td>
						<td>
							<a href="showAssetInfoHistory.action?paramId=<s:property value="#list.id"/>" style="float:inline;" target="_blank">查看</a>
						</td>
						<td>
			...
			<tr class="tfoot">
			      ...
			      <s:if test="#request.list.size==0"><span>无相关数据</span></s:if>
			      <s:else>
			      	<span class="fl">
				      	共<s:property value="#request.historyList.size()"/>条记录
				    </span>
				     <!-- 
