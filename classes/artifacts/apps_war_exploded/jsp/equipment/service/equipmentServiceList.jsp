...
<body>
	<div class="main"><!--Ctrl-->
			...
			<input type="hidden" name="pageNo" id="pageNo" value="<s:property value='#request.page.currentPageNo'/>"/>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr id="search" >
						...
						<td class="t_r">安装地点</td>
						<td>
							<input type="text" name="installSite" class="input_large" value="<s:property value='equipmentServiceInfo.implementUnit'/>" />
						</td>
					</tr>
					<tr>
		...
		<table width="100%" class="table_1">
			<thead>
				<th colspan="14">&nbsp;&nbsp;检修列表</th>
			</thead>
			<tbody>
				<tr class="tit">
					<td style="white-space: nowrap;">序号</td>
					<td style="white-space: nowrap;">设备名称</td>
					<td style="white-space: nowrap;">安装地点</td>
					<td style="white-space: nowrap;">检修程度</td>
					<td style="white-space: nowrap;">检修日期</td>
					<td style="white-space: nowrap;">实施单位</td>
					<td colspan="3" class="t_c">操作</td>
				</tr>
				<s:iterator value="#request.page.result" id="service" status="st">
					<tr class="t_c">
						...
						<td class="t_c">
							...
							<s:elseif test="#service.serviceLevel==3">中修</s:elseif>
						</td>
