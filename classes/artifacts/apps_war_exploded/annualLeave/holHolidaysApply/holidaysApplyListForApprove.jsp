		...
		<div class="tabs_2 nwarp">
        	<ul class="nwarp">
				...
				<li><a href="findHolHolidayApplyByPageForDept.action"><span>部门公休</span></a></li>
           		<li class="selected"><a href="findHolHolidayApplyByPageForApprove.action?holState=55"><span>公休审批</span></a></li>
            </ul>
        </div>
		<div class="filter">
			<div class="query p8" id="search">
			<s:form action="findHolHolidayApplyByPageForApprove" name="holHolidaysApply" namespace="/holHolidaysApply" method="post" id="form">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr id="search">
						...
						<td>
							...
							<input name="holState" value="55" type="hidden">
						</td>
						<!-- 
			...
			<tbody>
				...
				<s:iterator value="#request.page.result" id="holidayApply" status="st">
					<tr>
						...
						<td class="t_c"><s:property value="#request.userList[#st.index].name" /></td>
						...
						<td class="t_c" style="width: 100px;">
							<img alt="公休详细" src="<%=basePath %>/annualLeave/images/folder_open.gif" style="float: left;padding-left: 15px;cursor:pointer; " onclick="window.open('showApplyView.action?id=<s:property value="#holidayApply.id"/>')" >
							<img alt="同意" src="<%=basePath %>/annualLeave/images/agree.gif" style="float: left;padding-left: 15px;cursor:pointer;" onclick="agreeApply('<s:property value="#holidayApply.id"/>',59)">
							<img alt="驳回" src="<%=basePath %>/annualLeave/images/disagree.gif" style="float: left;padding-left: 15px;cursor:pointer;" onclick="agreeApply('<s:property value="#holidayApply.id"/>',60)">
						</td>
					</tr>
				</s:iterator>
			</tbody>
