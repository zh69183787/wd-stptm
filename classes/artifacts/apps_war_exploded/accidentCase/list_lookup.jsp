...
function crossDomainShowOrHide(){
	...
	function submitFormByCaseType(caseType){
		...
		$("#caseCTypeCode").val("");
		//alert("caseType333=="+caseType);
		clearInput();
		//alert("caseType=="+$("#caseType").val());
		$("#form").submit();
	...
	<div class="main">
        ...
        <div class="tabs_2">
        	<ul id="urlist">
        			...
        			<li><a href="#" onclick="submitFormByCaseType('')"><span>全部</span></a></li>
            	...
            	<div class="con">
					...
					<s:if test="caseType==4">
						<li>
                        	<h5><a href="#"></a></h5>
                            <ul>
                            	<li ><a href="findMetroAccidentCaseByPage2.action?caseCTypeCode=1&caseType=<s:property value='caseType'/>"></a></li>
