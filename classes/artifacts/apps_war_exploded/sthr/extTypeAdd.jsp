...
<table width="100%" class="table_1">
	...
	<tbody>
		<tr>
			...
			<td><input type="text" id="typeName" name="typeName" class="input_xlarge" value="<s:property value='#request.typeName'/>" maxlength="50"/></td>
		</tr>
		<tr>
			<td class="t_r lableTd">排列顺序</td>
			<td><input type="text" id="sortingOrder" name="sortingOrder" class="input_large" value="<s:property value='#request.sortingOrder'/>" maxlength="3"/></td>
		</tr>
	</tbody>
	<tr class="tfoot">
