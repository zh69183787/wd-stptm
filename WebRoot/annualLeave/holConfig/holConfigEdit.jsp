...
<!--[if IE 6.0]>
       ...
       <![endif]-->
		...
		function check(){
			...
			$.ajax({
				type : 'post',
				url : 'saveEditHolConfig.action?random='+Math.random(),
				data:{
					id:id,
					hdate:hdate,
					memo:memo
...
<body>
	<input id="id" type="hidden" value="<s:property value='#request.holConfig.id'/>">
	<div class="main">
    	<!--Ctrl-->
        ...
        <div class="mb10">
       	  <table width="100%"  class="table_1">
                   ...
                   <tr>
                     ...
                     <td style="width:85%;">
                     	<input type="text" id="hdate" name="hdate" class="input" readonly="readonly" value="<s:property value='#request.holConfig.hdate'/>"/>
                     </td>
                    </tr>
                   <tr>
                   	<td class="t_r lableTd" style="width:15%;">节假日名称</td>
                     <td style="width:85%;">
                     <input type="text" id="memo" name="memo" class="input_large" class="input" value="<s:property value='#request.holConfig.memo'/>"/></td>
                   </tr>
