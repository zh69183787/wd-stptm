	...
	<div class="main"><!--Ctrl-->
		...
		<div class="tabs_2 nwarp">
        	<ul class="nwarp">
				...
				<li class="selected"><a href="#"><span>公休查询</span></a></li>
		...
		<div class="filter">
			...
			<s:form action="findHolHolidayApplyByPage" name="holHolidaysApply" namespace="/holHolidaysApply" method="post" id="form">
			...
			<tbody>
				...
				<s:iterator value="#request.page.result" id="holidayApply" status="st">
					<tr>
						...
						<td class="t_c" style="width: 80px;">
							<img alt="详细" src="<%=basePath %>/annualLeave/images/folder_open.gif" onclick="window.open('showApplyView.action?id=<s:property value="#holidayApply.id"/>')" style="cursor: pointer;float: left;padding-left: 10px;">&nbsp;&nbsp;
							<s:if test="#holidayApply.holState==55">
								<img alt="取消申请" src="<%=basePath %>/annualLeave/images/delete.gif" onclick="agreeApply('<s:property value="#holidayApply.id"/>',61)" style="cursor: pointer;float: right;padding-right: 10px;">&nbsp;&nbsp;
							</s:if>
							
							
							<!-- 
							<s:if test="#holidayApply.holState==58">
								<a href="#" onclick="submitApply('<s:property value="#holidayApply.id"/>')">提交申请</a>
							</s:if>
							<s:elseif test="#holidayApply.holState==60">
								<a href="#" onclick="deleteApply('<s:property value="#holidayApply.id"/>')">删除</a>
							</s:elseif>
							 -->
						</td>
					</tr>
