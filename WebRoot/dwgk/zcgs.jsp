...
JSONObject rec=null;
String dwlmId="1238";//当前单位总栏目ID
String dtgzId="1372";//动态工作
//公开查询
String dzzjyId="1239";//党组织决议决定及执行
String ddsxId="1240";//党的思想建设
String ddzzId="1241";//党的组织管理
String ldbzId="1242";//领导班子建设
String gbxrId="1243";//干部选任和管理
String lxhffId="1244";//联系和服务党员、群众
String dflzId="1245";//党风廉政建设
String qtgkId="1246";//其他公开内容

String jqgkId="1375";//近期公开重点
//公开制度机制
String gzgkId="1378";//工作公开组织结构
String dwgkId="1379";//党务公开目录
String dzwjId="1380";//工作文件制度
%>
...
<div class="wrap">
  <div class="leftside">
    <div class="gzxx">
      <h3><a href="#" style="cursor:default"><em>资产公司-动态工作信息</em></a></h3>
      <div class="gzxx-info" >
...
%> 
    ...
    <ul class="t_news_tit">
        ...
        <li><a href="zcgs.jsp" class="f-yh current">资产公司</a></li>
