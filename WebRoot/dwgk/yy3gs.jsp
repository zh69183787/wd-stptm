...
String dwlmId="694";//当前单位总栏目ID
String dtgzId="872";//动态工作
//公开查询
String dzzjyId="706";//党组织决议决定及执行
String ddsxId="708";//党的思想建设
String ddzzId="709";//党的组织管理
String ldbzId="711";//领导班子建设
String gbxrId="713";//干部选任和管理
String lxhffId="715";//联系和服务党员、群众
String dflzId="717";//党风廉政建设
String qtgkId="718";//其他公开内容

String jqgkId="873";//近期公开重点
//公开制度机制
String gzgkId="876";//工作公开组织结构
String dwgkId="877";//党务公开目录
String dzwjId="878";//工作文件制度
%>
...
<div class="wrap">
  <div class="leftside">
    <div class="gzxx">
      <h3><a href="#" style="cursor:default"><em> 运营三公司-动态工作信息</em></a></h3>
      <div class="gzxx-info" >
...
%> 
    ...
    <div class="p_link">
     ...
     <ul class="t_news_tit">
        ...
        <li><a href="yy3gs.jsp" class="f-yh current">运营三公司</a></li>
