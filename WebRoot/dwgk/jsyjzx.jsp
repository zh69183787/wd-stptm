...
String dwlmId="810";//当前单位总栏目ID
String dtgzId="1335";//动态工作
//公开查询
String dzzjyId="813";//党组织决议决定及执行
String ddsxId="815";//党的思想建设
String ddzzId="816";//党的组织管理
String ldbzId="817";//领导班子建设
String gbxrId="819";//干部选任和管理
String lxhffId="820";//联系和服务党员、群众
String dflzId="822";//党风廉政建设
String qtgkId="823";//其他公开内容

String jqgkId="1336";//近期公开重点
//公开制度机制
String gzgkId="1339";//工作公开组织结构
String dwgkId="1340";//党务公开目录
String dzwjId="1341";//工作文件制度
%>
...
<body>
<div class="top"> <img src="images1/top.jpg"  /> </div>
<div class="wrap">
  <div class="leftside">
    <div class="gzxx">
      <h3><a href="#" style="cursor:default"><em> 技术研究中心-动态工作信息</em></a></h3>
      <div class="gzxx-info" >
...
%> 
    ...
    <ul class="t_news_tit">
        ...
        <li><a href="jsyjzx.jsp" class="f-yh current">技术研究中心</a></li>
