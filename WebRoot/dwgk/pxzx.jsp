...
String dwlmId="1071";//当前单位总栏目ID
String dtgzId="1363";//动态工作
//公开查询
String dzzjyId="1072";//党组织决议决定及执行
String ddsxId="1153";//党的思想建设
String ddzzId="1154";//党的组织管理
String ldbzId="1155";//领导班子建设
String gbxrId="1156";//干部选任和管理
String lxhffId="1157";//联系和服务党员、群众
String dflzId="1158";//党风廉政建设
String qtgkId="1159";//其他公开内容

String jqgkId="1364";//近期公开重点
//公开制度机制
String gzgkId="1367";//工作公开组织结构
String dwgkId="1368";//党务公开目录
String dzwjId="1369";//工作文件制度
%>
...
<div class="wrap">
  <div class="leftside">
    <div class="gzxx">
      <h3><a href="#" style="cursor:default"><em> 培训中心-动态工作信息</em></a></h3>
      <div class="gzxx-info" >
...
%> 
    ...
    <div class="p_link">
     ...
     <ul class="t_news_tit">
        ...
        <li><a href="pxzx.jsp" class="f-yh current">培训中心</a></li>
