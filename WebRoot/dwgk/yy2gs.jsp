...
String dwlmId="614";//当前单位总栏目ID
String dtgzId="1356";//动态工作
//公开查询
String dzzjyId="619";//党组织决议决定及执行
String ddsxId="621";//党的思想建设
String ddzzId="623";//党的组织管理
String ldbzId="624";//领导班子建设
String gbxrId="626";//干部选任和管理
String lxhffId="628";//联系和服务党员、群众
String dflzId="629";//党风廉政建设
String qtgkId="630";//其他公开内容

String jqgkId="1371";//近期公开重点
//公开制度机制
String gzgkId="1417";//工作公开组织结构
String dwgkId="1418";//党务公开目录
String dzwjId="1419";//工作文件制度
%>
...
<div class="wrap">
  <div class="leftside">
    <div class="gzxx">
      <h3><a href="#" style="cursor:default"><em> 运营二公司-动态工作信息</em></a></h3>
      <div class="gzxx-info" >
    ...
    <div class="p_link">
      <h3><em class="pubic"><a href="#" class="f-yh" style="cursor:default">各直属党组织链接</a></em></h3>
       <ul class="t_news_tit">
        ...
        <li><a href="yy2gs.jsp" class="f-yh current">运营二公司</a></li>
