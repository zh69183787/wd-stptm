...
String dwlmId="912";//当前单位总栏目ID
String dtgzId="1344";//动态工作
//公开查询
String dzzjyId="913";//党组织决议决定及执行
String ddsxId="914";//党的思想建设
String ddzzId="915";//党的组织管理
String ldbzId="916";//领导班子建设
String gbxrId="917";//干部选任和管理
String lxhffId="918";//联系和服务党员、群众
String dflzId="919";//党风廉政建设
String qtgkId="920";//其他公开内容

String jqgkId="1345";//近期公开重点
//公开制度机制
String gzgkId="1349";//工作公开组织结构
String dwgkId="1351";//党务公开目录
String dzwjId="1352";//工作文件制度
%>
...
<div class="wrap">
  <div class="leftside">
    <div class="gzxx">
      <h3><a href="#" style="cursor:default"><em> 大桥公司-动态工作信息</em></a></h3>
      <div class="gzxx-info" >
...
%> 
    ...
    <div class="p_link">
     ...
     <ul class="t_news_tit">
        ...
        <li><a href="dqgs.jsp" class="f-yh current">大桥公司</a></li>
