...
<!--[if IE 6.0]>
      ...
      function deleteData(caseId){
      	if(confirm("确定删除?")){
      		window.location.href="deleteByIdAndUpdatePerson.action?caseId="+caseId+"&caseType="+$("#caseType").val();
      	}
      }
...
<body>
	...
	<div class="main">
      ...
      <div class="filter">
        	...
        	<s:form action="findMetroAccidentCaseByUpdatePerson" id="form" name="MetroAccidentCase" namespace="/accidentCase">
										...
										<s:elseif test="approvalStatus==0001">
											<a class="fl mr5" href="findMetroAccidentCaseById.action?caseId=<s:property value='caseId'/>&type=view&caseType=<s:property value='metroAccidentCaseVO.caseType'/>" target="_blank">查看</a> 
	  	                            		<a class="fl mr5" href="javascript:void(0)" onclick="deleteData('<s:property value='caseId'/>')">删除</a> 
	  	                           			<a class="fl mr5" href="findByIdAndUpdatePerson.action?caseId=<s:property value='caseId'/>&type=edit&caseType=<s:property value='metroAccidentCaseVO.caseType'/>" target="_blank">修改</a>
										</s:elseif>
	  	                            </td>
	                            </tr>
	                            </s:iterator>
