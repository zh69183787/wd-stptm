            ...
            <th colspan="4" class="t_r"><input type="submit" value="保 存" onclick="return moreSubmit()"/>
        	      ...
        	      &nbsp;
                              ...
                              <tr>
                                ...
                                <td class="t_r lableTd">审核状态<s:property value="metroAccidentCaseVO.approvalStatus"/></td>
                                <td>
                                	 <s:if test="metroAccidentCaseVO.approvalStatus==00001">待审核</s:if>
	        	   					 <s:elseif test="approvalStatus==00002">预审通过</s:elseif>
	        	   					 <s:elseif test="approvalStatus==00003">终审通过</s:elseif>
                                	<input type="hidden" name="approvalStatus" value="<s:property value='metroAccidentCaseVO.approvalStatus'/>">
                                </td>
                                </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td colspan="3"><input type="text" id="responsibleDeptName" name="responsibleDeptName" maxlength="20" class="input_xlarge" value="<s:property value='metroAccidentCaseVO.responsibleDeptName'/>"/></td>
                                </tr>
                              <tr>
