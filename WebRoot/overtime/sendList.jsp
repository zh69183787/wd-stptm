		...
		<div class="main">
			...
			<div class="tabs_2">
				<ul id="urlist" style="float: left">
					<li>
						<a href="showReceiveList.action"><span>收文查询</span>
						</a>
					</li>
					<li class="selected">
						<a href="showSendList.action"><span>发文查询</span>
						</a>
					</li>
					<li>
						<a href="showReceiveDirectiveList.action"><span>呈批查询</span>
						</a>
					</li>
					<li>
						<a href="showSubprocessList.action"><span>合同审批查询</span>
						</a>
					</li>
					<li>
						<a href="showTaskList.action"><span>直接备案查询</span>
						</a>
					</li>
					<li>
						<a href="showIncidentsList.action"><span>维保合同审批查询</span>
						</a>
					</li>
					<li>
						<a href="showHtXxList.action"><span>合同审批查询（旧）</span>
						</a>
					</li>
				</ul>
			...
			<div class="filter">
				...
				<div class="query p8">
					...
					<s:form action="showSendList" id="form" name="/showSendList"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td style="white-space: nowrap;">
									<input type="text" id="beginDate" name="docSend.beginDate"
										style="width: 116px"
										onClick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly: true})"
										value="<s:property value="docSend.beginDate"/>"
										readonly="readonly" />
									至
									<input type="text" id="endDate" name="docSend.endDate"
										style="width: 116px"
										onClick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly: true})"
										value="<s:property value="docSend.endDate"/>"
										readonly="readonly" />
								</td>
								...
								<td>
									<input type="text" id="sender" name="docSend.sendId"
										class="input_large"
										value="<s:property value="docSend.sendId"/>" />
								</td>
								...
								<td>
									<input type="text" id="sender" name="docSend.docTitle"
										class="input_large"
										value="<s:property value="docSend.docTitle"/>" />
								</td>
							...
							<tr>
								...
								<td>
									<input type="text" id="sender" name="docSend.docCount"
										class="input_large"
										value="<s:property value="docSend.docCount"/>"
								...
								<td>
									<input type="text" id="sender" name="docSend.name" class="input_large"
								...
								<td>
									<input type="text" id="sender" name="docSend.operator"
										class="input_large"
										value="<s:property value="docSend.operator"/>" />
								</td>
							</tr>
							<tr>
								<td class="t_r" style="white-space: nowrap;">
								...
								<td>
									<input type="text" id="sender" name="docSend.content"
										class="input_large"
										value="<s:property value="docSend.content"/>" />
								</td>
								...
								<td>
									<select id="processstatus" name="docSend.processstatus">
										<option value="">
											全部
										</option>
										<option value="1">
								...
								<td colspan="3">
									<input type="text" id="sender" name="docSend.overTime"
										class="input_large"
										value="<s:property value="docSend.overTime"/>"
										onkeyup="this.value=this.value.replace(/[^\d]/g,'') " />
								</td>
							</tr>
 				<tr>
        	      <td class="t_r" style="white-space:nowrap;">分类</td>	  
        	       <td>
                   	<select  id="unittype" name="docSend.unittype" >
                        <option value="">全部</option>
                       <option value="沪地铁">沪地铁</option>
						<option value="会议">会议</option>
						<option value="沪地铁抄告">沪地铁抄告</option>
						<option value="沪地铁办">沪地铁办</option>
					</select> 
                   </td>
        	       <td class="t_r" style="white-space:nowrap;">年份</td>	  
        	       <td colspan="3">
                   	<select  id="year" name="docSend.year">
                    	<option value=""></option>
                    </select>
                   </td>
      	        </tr>
						...
						<s:iterator value="#r.list" id="items" status="s">
							...
							<tr>
								<td class="t_c" style="width: 150px;">
									...
									<font color="red"><b>(超时<s:property value="#items[1]" />天)</b></font>
								</td>
								...
								<!-- 签发-->
								<td class="t_c" style="width: 150px; text-align: left;">
									<s:property value="#items[13]" />
								</td>

								<!-- 经办-->
								<td class="t_c" style="width: 150px;">
									<s:property value="#items[14]" />
								</td>
								...
								<td class="t_c" style="width: 150px;">
									<s:if test="#items[19]==1">
											预归档
									  </s:if>
									<s:elseif test="#items[19]==2">
											进行中
									  </s:elseif>
									<s:elseif test="#items[19]==3">
											已归档
									  </s:elseif>
								</td>

								<!-- 表单-->
								<td class="t_c" style="width: 150px;" align="center">
									<a style="cursor: pointer; text-align: center;"
										onclick="return openForm1('','<s:property value="#items[16]"/>','<s:property value="#items[17]"/>','<s:property value="#items[16]"/>','<s:property value="#items[17]"/>')"><img
											src="../images/open.gif" />
									</a>
								</td>
								<!-- 监控-->
								<td class="t_c" style="width: 150px;" align="center">
									<a style="cursor: pointer; text-align: center;"
										onclick="return openScan1('<s:property value="#items[16]"/>','<s:property value="#items[17]"/>')"><img
											src="../images/but9.gif" />
									</a>
								</td>
