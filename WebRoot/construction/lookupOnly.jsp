...
<input type="hidden" id="lineNo" value="<s:property value='tConstructionNoticeVO.lineNo'/>">
        	<div class="query p8">
        		<s:form action="findTConstructionNoticeOnly" name="TConstructionNotice" namespace="/construction" id="form">
	        	    ...
	        	    <td class="t_r">线路</td>
	        	     <td>
	        	      ...
	        	      <td>
	        	      	...
	        	      	<input type="text" id="startDate" name="startDate" class="input_large" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" value="<s:date name='constructionStartDate' format='yyyy-MM-dd HH:mm'/>" readonly="readonly"/>
	        	      	— <input type="text" id="endDate" name="endDate" class="input_large" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" value="<s:date name='constructionEndDate' format='yyyy-MM-dd HH:mm'/>" readonly="readonly"/>
	        	      </td>
