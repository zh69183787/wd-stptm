	...
	<table width="100%" class="table_1">
		...
		<tbody id="formBody">
			<tr>
				...
				<td>
					<input type="text" id="" name="partsName" class="input_large" />
				</td>
				<td class="t_r lableTd">数量</td>
				<td >
					<input type="text" id="" name="partsAmount" class="input_large" />
				</td>
			</tr>
			<tr>
				<td class="t_r lableTd">规格型号</td>
				<td>
					<input type="text" id="" name="productModel" class="input_large" />
				</td>
				<td class="t_r lableTd">生产厂家</td>
				<td >
					<input type="text" id="" name="manufacturer" class="input_large" />
				</td>
			</tr>
			<tr>
				<td class="t_r lableTd">单价</td>
				<td><input type="text" name="price" class="input_large" /></td>
				<td class="t_r lableTd">费用</td>
				<td><input type="text" name="cost" class="input_large" /></td>
			</tr>
			<tr>
				<td class="t_r lableTd">消耗率</td>
				<td><input type="text" id="" name="consumeRate" class="input_large" /></td>
				<td class="t_r lableTd">更换日期</td>
				<td><input type="text" id="" name="replaceDate" class="input_large date" readonly="readonly"/></td>
			</tr>
			<tr>
				<td class="t_r lableTd">备注</td>
				<td colspan="3">
					<textarea rows="3" cols="4" name="notes"></textarea>
				</td>
			</tr>
		</tbody>
		<tr class="tfoot">
