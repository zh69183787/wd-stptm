...
<body>
	<div class="main"><!--Ctrl-->
		...
		<div class="filter">
			<div class="query p8">
			<s:form action="showEquipmentList" name="paramCheck" namespace="/paramCheck" method="post" id="form">
		...
		<table width="100%" class="table_1">
			...
			<tbody>
				<tr class="tit">
					<td class="t_c">序号</td>
					<td class="t_c">设备编号</td>
					<td class="t_c">设备名称</td>
					<td class="t_c">生产厂家</td>
					<td class="t_c">产地</td>
					<td class="t_c">规格型号</td>
				...
				<s:iterator value="#request.page.result" id="equipment" status="st">
					<tr class="t_c">
						...
						<td class="t_c">
							<a href="showAdd.action?id=<s:property value="#equipment.id"/>" style="float:inline;" target="_blank">新增检查</a>
						</td>
						<td class="t_c">
							<a href="showHistoryCheck.action?id=<s:property value="#equipment.id"/>" style="float:inline;" target="_blank">历史检查</a>
						</td>
					</tr>
				</s:iterator>
			</tbody>
