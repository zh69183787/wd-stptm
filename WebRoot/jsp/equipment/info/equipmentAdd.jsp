...
function checkForm(){
	...
	var status =true;
	$("input[name$=aramName]").each(function(){
		var value = $(this).val(); 
		if(trim(value)==""){
			status = false;
			$(this).focus();
...
function addParams(){
	var addHtml = "<tr>"+
					...
					"<td colspan='1' style='width: 500px;'>"+
						"参数名称：<input type='text' name='paramName' maxlength='20'>"+
					"</td>"+
					"<td colspan='3'>"+
						"参数值：<input type='text' name='paramValue' maxlength='20'>"+
					"</td>"+
				"</tr>";
	...
	<table width="100%" class="table_1">
		...
		<tbody id="formBody">
			<tr>
				...
				<td colspan="3" id="must">
					<input type="text" id="assetId" class="input_large" name="assetId" maxlength="20" value="<s:property value="equipmentInfo.assetId"/>"/>&nbsp;&nbsp;*
				</td>
			</tr>
			<tr>
				<td class="t_r lableTd">设备编号</td>
				<td colspan="3" id="must">
					<input type="text" id="" name="equipmentId" class="input_large" maxlength="50" value="<s:property value="equipmentInfo.equipmentId"/>"/>&nbsp;&nbsp;*
				</td>
			</tr>
			<tr>
				<td width="10%;" class="t_r lableTd">设备名称</td>
				<td width="40%;" id="must"><input type="text" name="equipmentName" class="input_large" maxlength="50" value="<s:property value="equipmentInfo.equipmentName"/>"/>&nbsp;&nbsp;*</td>
				<td width="10%;" class="t_r lableTd">规格型号</td>
				<td width="40%;"><input type="text" name="productModel" class="input_large" maxlength="50" value="<s:property value="equipmentInfo.productModel"/>"/></td>
			</tr>
			<tr>
				<td class="t_r lableTd">产地</td>
				<td><input type="text" id="" name="provenance" class="input_large" maxlength="50" value="<s:property value="equipmentInfo.provenance"/>"/></td>
			...
			<tr>
				...
				<td><input type="text" id="" name="usefulLife" class="input_large" maxlength="10" value="<s:property value="equipmentInfo.usefulLife"/>"/>月</td>
				<td class="t_r lableTd">安装位置</td>
				<td><input type="text" id="" name="installSite" class="input_large" maxlength="50" value="<s:property value="equipmentInfo.installSite"/>"/></td>
			</tr>
			<tr>
				<td class="t_r lableTd">大修频率</td>
				<td><input type="text" id="" name="heavyRepairFrequency" class="input_large" maxlength="10" value="<s:property value="equipmentInfo.heavyRepairFrequency"/>"/>月/次</td>
				<td class="t_r lableTd">中修修频率</td>
				<td><input type="text" id="" name="mediumRepairFrequency" class="input_large" maxlength="10" value="<s:property value="equipmentInfo.mediumRepairFrequency"/>"/>月/次</td>
			</tr>
			<tr>
				<td class="t_r lableTd">生产厂家</td>
				<td id="must">
					<input id="hideManufacturer" name="manufacturer" type="hidden" value="<s:property value="equipmentInfo.manufacturer"/>">
					<input id="showManufacturer" type="text" class="input_xxlarge" name="manufacturerName" value="<s:property value="#request.manufacturerName"/>">
					&nbsp;&nbsp;*
				</td>
				<td class="t_r lableTd">单价</td>
				<td><input type="text" id="" name="price" class="input_large" maxlength="50" value="<s:property value="equipmentInfo.price"/>"/>元</td>
			</tr>
			<tr>
				<td class="t_r lableTd">备注</td>
				<td colspan="3">
					<textarea rows="5" cols="6" name="notes"><s:property value="equipmentInfo.notes"/></textarea>
				</td>
			</tr>
			<tr>
				<td><input type="button" value="添加设备参数" onclick="addParams();" style="float: right;"/></td>
				<td><input type="button" value="删除设备参数" onclick="removeParams();" /></td>
				<td colspan="4"></td>
			</tr>
			<!-- 
			<tr>
