...
function checkSonWindow(){
	if(sonWindow!=null && sonWindow.closed==true){
		window.location.href = "showListCommon.action";
...
<body>
	<div class="main"><!--Ctrl-->
		...
		<div class="filter">
			<div id="searchArea" class="query p8" >
			<s:form action="showListCommon" name="task" namespace="/task" method="post" id="form">
			...
			<input type="hidden" name="taskuser" value="<s:property value="#request.userId"/>">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr id="search">
						<td class="t_r" style="white-space: nowrap;">任务名称</td>
						<td style="white-space: nowrap;">
							<input type="text" name="taskname" id="textfield" class="input_large" value="<s:property value='assetTask.taskname'/>" />
						</td >
						<td class="t_r" style="white-space: nowrap;">任务开始时间</td>
						<td style="white-space: nowrap;">
							<input type="text" name="start1" class="input_large date" value="<s:property value='#request.start1'/>" readonly="readonly">至
							<input type="text" name="start2" class="input_large date" value="<s:property value='#request.start2'/>" readonly="readonly">
						</td>
						<td class="t_r" style="white-space: nowrap;">任务结束时间</td>
						<td style="white-space: nowrap;">
							<input type="text" name="end1" class="input_large date" value="<s:property value='#request.end1'/>" readonly="readonly">至
							<input type="text" name="end2" class="input_large date" value="<s:property value='#request.end2'/>" readonly="readonly">
						</td>
					</tr>
					<tr>
			...
			<tbody>
				...
				<s:iterator value="#request.page.result" id="task" status="st">
					<tr class="t_c">
						...
						<td class="t_c">
							<s:if test="#task.taskstatus==0">进行中</s:if>
							<s:else>已过期</s:else>
						</td>
						<!-- 
						...
						<td>
							<a href="showView.action?id=<s:property value="#task.id"/>" style="float:inline;" target="_blank">详情</a>
						</td>
						<td class="t_c">
							<a href="downloadAssetTaskAsXML.action?paramId=<s:property value="#task.id"/>" style="float:inline;">下载</a>
						</td>
					</tr>
				</s:iterator>
			</tbody>
