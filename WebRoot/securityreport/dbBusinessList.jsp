        	...
        	<table width="100%"  class="table_1">
        					 <thead>
                              ...
                              <s:if test="#items[11]>0 && #items[8]==null">
                                ...
                                <td class="t_c">
	  	                            	<a class="fl mr5" href="toDbBusinessView.action?id=<s:property value="#items[9]"/>&deptName=<s:property value="#items[2]" />" target="_blank" >查看</a> 
	  	                            	<a class="fl mr5" href="/apps/dbFollow/toFollowView.action?id=8a81aba93f567b63013f56804c100004&deal=1" target="_blank" >跟踪</a> 
	  	                        </td>
                               </s:if>
                               <s:else>
                                ...
                                <td class="t_c">
	  	                            	<a class="fl mr5" href="toDbBusinessView.action?id=<s:property value="#items[9]"/>&deptName=<s:property value="#items[2]" />" target="_blank" >查看</a> 
	  	                            	<a class="fl mr5" href="toFollowView.action?id=<s:property value='id'/>&deal=1" target="_blank" >跟踪</a> 
	  	                        </td>
                               </s:else>
                                </tr>
                                </s:iterator>
