    ...
    <table width="100%"  class="table_1">
        ...
        <s:iterator value="#request.page.result" status="st">
            <tr id="dataTR">
                ...
                <td class="t_c">
                    <s:if test="#request.operateType==1">
                        <a class="fl mr5" style="display:inline" href="findHiddenDangersCorrectById.action?id=<s:property value='id'/>&type=view" target="_blank" >查看</a>
                        <a class="fl mr5" style="display:inline" href="javascript:void(0)" onclick="editData('<s:property value='id'/>')">修改</a>
                    ...
                    <s:elseif test="#request.operateType==2">
                        <a class="mr5" href="findHiddenDangersCorrectById.action?id=<s:property value='id'/>&type=view" target="_blank" >查看</a>
                        <%--   <a class="fl mr5" href="javascript:void(0)" onclick="deleteData('<s:property value='id'/>')">删除</a>
                         <a class="fl mr5" href="javascript:void(0)" onclick="editData('<s:property value='id'/>')">修改</a>--%>
                    </s:elseif>
                    <s:else>
                        <!-- 郁琦辉 -->
                        <a class="  <%if("G001000001892519".equals(loginName)){%>fl<%}%> mr5" href="findHiddenDangersCorrectById.action?id=<s:property value='id'/>&type=view" target="_blank" ><s:property value="#cookie.client.loginName"/>查看</a>
                        <%if("G001000001892519".equals(loginName)){%>
                            <a class="fl mr5" href="javascript:void(0)" onclick="deleteData('<s:property value='id'/>')">删除</a>
                            <a class="fl mr5" href="javascript:void(0)" onclick="editData('<s:property value='id'/>')">修改</a>
                       <%}%>
                    </s:else>
