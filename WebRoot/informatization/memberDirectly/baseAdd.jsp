...
<input type="hidden" id="addSuccess" value="<s:property value='#request.addSuccess'/>"/>
	...
	<div class="main">
		...
		<div class="ctrl clearfix">
            ...
            <div class="posi fl">
            	<ul>
                	...
                	<li class="fin">(各直属单位团组织)主题活动信息</li>
                </ul>
            </div>
        ...
        <!--Table-->
        <div class="mb10">
        <s:form action="add" name="memberDirectly" namespace="/memberDirectly" method="post">
            ...
            <th colspan="4" class="t_r"><input type="submit" value="确 认" onclick="return check();"/>
       	      ...
       	      &nbsp;</th>
                              ...
                              <tr>
                                ...
                                <td><input type="text" id="activeTitleOrContext" name="activeTitleOrContext" maxlength="18" class="input_large" /></td>
                                <td class="t_r lableTd">时间</td>
                                <td>
                                <input type="date" id="time" name="time" maxlength="20" class="input_large" /></td>
                              ...
                              <tr>
                                ...
                                <td>
                                <input type="text"  id="address" name="address" class="input_large" />
                                </td>
                                <td class="t_r lableTd">负责人</td>
                                <td>
                                <input type="text" name="head" id="head" class="input_large">
                                    
                                </td>
                                </tr>
                              <tr>
                                <td class="t_r lableTd">参与人数</td>
                                <td><input type="text" id="participation" name="participation" maxlength="20" class="input_large" /></td>
                                <
                              </tr>
