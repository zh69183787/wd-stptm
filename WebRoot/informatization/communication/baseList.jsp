...
<head>
<meta charset="utf-8" />
<title>本级和下级团组织利用新媒体工具拓宽沟通和响应渠道情况</title>
...
<!--[if IE 6.0]>
	  ...
	  if(confirm("确定删除?")){
		$.ajax({
			url: "<%=basePath%>/communication/deleteData.action",
			dataType: "json",
			data: {
				"id" : id
			},
	...
	<div class="main">
		...
		<div class="ctrl clearfix">
            ...
            <div class="posi fl">
            	<ul>
                	...
                	<li class="fin">本级和下级团组织利用新媒体工具拓宽沟通和响应渠道情况</li>
                </ul>
            </div>
        ...
        <div class="tabs_2">
        	<ul>
           		...
           		<li class="selected"><a href="<%=basePath %>/communication/findByPage.action"><span>拓宽沟通和响应渠道</span></a></li>
      ...
      <div class="filter">
        	<div class="query p8">
        	<s:form action="findByPage" id="form" name="communication" namespace="/communication">        	
        	<input type="hidden"  value="" name="number" id="pageNo"/>
        	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        	    <tr>
        	      <td class="t_r">技术手段</td>
        	      <td>
       	          <select name="technicalMeans" id="technicalMeans" class="input_large">
                                ...
                                <input type="hidden" id="h_technicalMeans" value="<s:property value='technicalMeans'/>">
        	      ...
        	      <select name="directlyUnitName" id="directlyUnitName" class="input_large">
                                ...
                                <input type="hidden" id="h_directlyUnitName" value="<s:property value='directlyUnitName'/>">
        	      </td>
...
<input type="button" value="重置" onclick="clearInput()"/> &nbsp;&nbsp;
        ...
        <div class="mb10">
        	<table width="100%"  class="table_1">
                              <thead>
                                  <th colspan="18">本级和下级团组织利用新媒体工具拓宽沟通和响应渠道情况</th>
                              </thead>    
                              <tbody>
                              <tr class="tit">
                                <td>序号</td>
