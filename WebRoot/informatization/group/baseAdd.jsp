...
<input type="hidden" id="addSuccess" value="<s:property value='#request.addSuccess'/>"/>
	...
	<div class="main">
        ...
        <!--Table-->
        <div class="mb10">
        <s:form action="add" name="member" namespace="/member" method="post">
            ...
            <th colspan="4" class="t_r"><input type="submit" value="确 认" onclick="return check();"/>
       	      ...
       	      &nbsp;</th>
                              ...
                              <tr>
                                ...
                                <td style="color:red"><input type="text" id="groupMale" name="groupMale" class="input_large" maxlength="20" />&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                              <tr>
                                <td class="t_r lableTd">共青团员女</td>
                                <td><input type="text" id="groupFemMale" name="groupFemMale" maxlength="18" class="input_large" /></td>
                                <td class="t_r lableTd">35岁以下青年（含35岁）男</td>
                                <td>
                                <input type="text" id="under_35YouthMale" name="under_35YouthMale" maxlength="18" class="input_large" /></td>
                                
                                </td>
                                </tr>
                              <tr>
                                <td class="t_r lableTd">更新时间</td>
                                <td><input id="updateDate" name="updateDate" type="date" readonly="readonly" class="input_large"/></td>
                                <td class="t_r lableTd">35岁以下青年（含35岁）女</td>
                                <td><input type="text" id="under_35YouthFemale" name="under_35YouthFemale" maxlength="20" class="input_large" /></td>
                                </tr>
                              <tr>
                                <td class="t_r lableTd">28岁以下未入团青年（含28岁）</td>
                                <td><input type="text" id="under_28YouthNotGroup" name="under_28YouthNotGroup" maxlength="20" class="input_large" /></td>
                                <td class="t_r lableTd">28岁党员（含28岁）</td>
                                <td>
                                <input type="text" id="member28" name="member28" maxlength="20" class="input_large" /></td>
                              ...
                              <tr>
                                ...
                                <td>
                                  <input type="text" id="member35" name="member35" maxlength="20" class="input_large" /></td>
                                
                                <td class="t_r lableTd">今年新入团人数</td>
                                <td><input type="text" id="newGroup" name="newGroup" class="input_large" /></td>
                              </tr>
                              <tr>
                                <td class="t_r lableTd">今年推优入党人数</td>
                                <td><input type="text" id="newMember" name="newMember" maxlength="6" class="input_large" /></td>
