...
package com.wonders.stpt.construction.ConstructionMetroLine.action;

import com.wonders.stpt.construction.ConstructionMetroLine.entity.vo.ConstructMetroLineVO;
...
public class MetroLineAction extends BaseAjaxAction {
	...
	private ConstructMetroLineVO metroLineVO = new ConstructMetroLineVO();
	private ConstructionMetroLineService metroLineService;
	...
	public String findMetroLineById() {
		...
		ConstructMetroLine bo = metroLineService.findConstructMetroLineById(id);
		if (bo != null) {
