...
@Entity
@Table(name = "T_HOL_HOLIDAYAPP")
public class THolHolidayapp implements Serializable, BusinessObject {
	...
	public HolHolidayApply convert(THolHolidayapp t) {
		HolHolidayApply h = new HolHolidayApply();
		h.setApplyDate(t.getApplyDate());
		h.setApplyUser(t.getApplyUser());
		h.setCheckDate(t.getCheckDate());
		h.setCheckResult(t.getCheckResult());
		h.setCheckUser(t.getCheckUser());
		h.setHolComment(t.getHolComment());
		h.setHolDays(t.getHolDays());
		h.setHolDeptId(t.getHolDeptId());
		h.setHolState(t.getHolState());
		h.setId(t.getId());
		h.setNoticeIdList(t.getNoticeIdList());
		h.setNoticeNameList(t.getNoticeNameList());
		h.setRemoved(t.getRemoved());
		h.setStartDate(t.getStartDate());
		return h;
	}
