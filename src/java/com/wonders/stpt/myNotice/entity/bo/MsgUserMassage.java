package com.wonders.stpt.myNotice.entity.bo;

import java.text.SimpleDateFormat;
import java.util.Date;

public class MsgUserMassage {
	...
	public int getHasAtta() {
		return hasAtta;
	}

	public void setHasAtta(int hasAtta) {
		this.hasAtta = hasAtta;
	}
