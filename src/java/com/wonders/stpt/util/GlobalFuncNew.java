...
public class GlobalFuncNew extends JdbcDaoSupport {
    public static String getByIdMobile(String id){
        ...
        Object obj =CommonDao.GetNewDatabaseDao().fetchColumn(sql);
        if(obj !=null){
            mobile = obj.toString();
        }
        return mobile;
    ...
    public static String getIdByLoginName(String logiName) {
        ...
        Object obj =CommonDao.GetNewDatabaseDao().fetchColumn(sqls);
        if(obj!=null){
            id = obj.toString();
        }
        return id;
	...
	/*public static void insertMsg(String id, String mobile, String content,AbstractHibernateDaoImpl dao )  {
		try{
			...
			if(dao !=null){
				...
				dao = CommonDao.GetNewDatabaseDao();
    ...
    public static OrganNode GetNodeByCode(String code){
        ...
        try{
            ...
            CommonDao dao = CommonDao.GetNewDatabaseDao();
    ...
    public static OrganTree getOrganTreeByCode(String code){
        ...
        try{
            ...
            List list = CommonDao.GetNewDatabaseDao().fetchAll(sql);
    ...
    public static List<Map> getUsersByOrganOrder(String nodeId){
        ...
        try{
            ...
            List lst = CommonDao.GetNewDatabaseDao().fetchAll(sql);
            if(lst != null){
                for (int i = 0; i < lst.size(); i++) {
    ...
    public static List<Object[]> getDepts(){
        List<Object[]> deptList = new ArrayList<Object[]>();
        try{
            String sql="select ID,NAME from V_ORGAN_TREE where LEVELS = 1 and TYPE_ID = '2' order by ORDERS asc";
            List lst = CommonDao.GetNewDatabaseDao().fetchAll(sql);
            if(lst != null){
            	return lst;
            }
    ...
    public static List<Object[]> getDeptByName(String name){
        List<Object[]> deptList = new ArrayList<Object[]>();
        try{
            String sql="select ID,NAME from V_ORGAN_TREE where LEVELS = 1 and TYPE_ID = '2' and NAME = '"+name+"' order by ORDERS asc";
            List lst = CommonDao.GetNewDatabaseDao().fetchAll(sql);
            if(lst != null){
            	return lst;
            }
