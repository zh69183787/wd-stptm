...
package com.wonders.stpt.accidentCase.TAttach.entity.bo;
...
@Entity
@Table(name = "T_ATTACH")
public class TAttach implements Serializable, BusinessObject {
...
//	private String matchDegree; // matchDegree
	...
	@Column(name = "MATCH_DEGREE", nullable = true, length = 10)
