...
package com.wonders.stpt.csUser.entity.bo;
...
public class CsUser implements Serializable, BusinessObject {
	...
	private Long createdate; // createdate
	...
	private String resetCode; // resetCode
	...
	@Column(name = "CERTIFICATE", nullable = true, length = 255)
	...
	@Column(name = "EXT6", nullable = true, length = 255)
	...
	@Column(name = "EXT7", nullable = true, length = 255)
	...
	@Column(name = "EXT8", nullable = true, length = 255)
	...
	@Column(name = "RESET_CODE", nullable = true, length = 255)
