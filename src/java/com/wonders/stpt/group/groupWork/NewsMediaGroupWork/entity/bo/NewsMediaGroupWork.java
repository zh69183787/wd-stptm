package com.wonders.stpt.group.groupWork.NewsMediaGroupWork.entity.bo;
...
//
//本级和下级团组织利用其他新闻媒体手段开展工作情况
@Entity
@Table(name="T_GROUP_WORK")
public class NewsMediaGroupWork implements Serializable ,BusinessObject {
	...
	private String release;//发行频率及累计发行量（期）
