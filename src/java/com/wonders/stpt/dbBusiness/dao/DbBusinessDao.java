...
package com.wonders.stpt.dbBusiness.dao;
...
public interface DbBusinessDao extends AbstractHibernateDao<DbBusiness> {
	 ...
	 * @return 分页后的数据
	 */
//	public Page findDbBusinessByPage(Map<String, Object> filter, int pageNo, int pageSize);
